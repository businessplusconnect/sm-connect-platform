        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6">
              {features.map(feature => <div key={feature.title} className="flex items-start gap-4">
          ...
          {/* Image à droite */}
          <div className="lg:w-1/2">
            <img src="/lovable-uploads/47970025-71a1-4a65-a9e0-8c4cd6ed0322.png" alt="Fonctionnalités de SM-CONNECT" className="w-full rounded-lg" />
          </div>
        </div>
      </div>
    </section>;
