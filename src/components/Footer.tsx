        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <p className="text-gray-600">SM-Connect est une application entièrement hébergée dans le cloud, garantissant accessibilité, performance et sécurité optimales.</p>
